...
<head>
    ...
    <title>Admin Section- Magage Topics</title>
            ...
            <table>
                ...
                <tbody> 
                    ...
                    <tr>
                        ...
                        <td><a href="edit-topic.php?id=<?php echo $topic['id'];?>" class="edit">edit</a></td>
                        <td><a href="index-topic.php?del_id=<?php echo $topic['id']; ?>" class="delete">delete</a></td>
                    </tr>
                    <?php endforeach; ?>
